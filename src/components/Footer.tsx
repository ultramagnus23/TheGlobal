...
function EntityBlock({
  ...
  return (
    <div className="space-y-2">
      ...
      <p className="text-base text-[#C8D2DC]">{entity.mandate}</p>
      <p className="text-base text-[#C8D2DC]">{entity.address}</p>
      <p className="text-base text-[#C8D2DC]">GSTIN: {entity.gstin}</p>
      ...
      <div className="mx-auto max-w-7xl px-4 md:px-8 py-16 md:py-24">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="space-y-3">
            <p className="font-display text-2xl font-bold">{facts.brand.name}</p>
            <p className="text-base text-[#C8D2DC] max-w-[28ch]">
              Construction materials distribution, headquartered in Jaipur, Rajasthan since{" "}
              {facts.brand.established}.
            </p>
          </div>

          <div className="space-y-3">
            <p className="text-base font-semibold uppercase tracking-[0.1em] text-[#C8D2DC]">
              Sitemap
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-white/15 space-y-2">
          <p className="text-base text-[#C8D2DC]">{facts.hours}</p>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-white/15 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <p className="text-base text-[#C8D2DC]">
